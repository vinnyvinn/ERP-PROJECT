...
function defaultCompany()
{
	...
	echo "<a target='_blank' href='".$SysPrefs->power_url."'><img src='$path_to_root/themes/$def_theme/images/logo_frontaccounting.png' alt='FrontAccounting' height='100' onload='fixPNG(this)' border='0' ></a>";
	echo "</td>\n";
	end_row();
