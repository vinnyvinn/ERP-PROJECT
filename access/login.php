...
function defaultCompany()
{
	...
	$title = $login_timeout ? _('Authorization timeout') : 'WIZAG FRONT ACCOUNT';
	...
	echo "<link href='$path_to_root/themes/$def_theme/custom.css' rel='stylesheet' type='text/css'> \n";
	...
	echo "<table class='titletext'><tr><td><a href='wizag.biz'> <img src='$path_to_root/themes/images/wizagimg.png'/> </a></td></tr></table>\n";
	...
	if (!$login_timeout) { // FA logo
    	echo "<a target='_blank' href='".$SysPrefs->power_url."'><img src='$path_to_root/themes/images/wizerpLogo.png' alt='FrontAccounting' height='100' onload='fixPNG(this)' border='0' ></a>";
	} else { 
	...
	if ($login_timeout) {
		...
		if (!@$SysPrefs->text_company_selection) {
			echo "<tr><td class='label'>"._("Company")."</td><td><select name='company_login_name' class='form-control'>\n";
	...
	echo "<script src='$path_to_root/themes/customization/custom.js'></script> \n";
	// echo "</div>";
	echo "</body></html>\n";
